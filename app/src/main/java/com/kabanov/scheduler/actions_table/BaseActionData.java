...
public class BaseActionData implements Serializable {
    ...
    public BaseActionData(String id, String name, int periodicityDays) {
        this(id, name, periodicityDays, new Date());    
    }

    public BaseActionData(String id, String name, int periodicityDays, Date lastExecutionDate) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        BaseActionData that = (BaseActionData) o;
